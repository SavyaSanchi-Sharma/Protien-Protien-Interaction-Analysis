...
def build(trial):
    hp = {
        ...
        "focal_gamma":    trial.suggest_float("focal_gamma", 1.0, 2.0),
        "proj_dropout":   trial.suggest_float("proj_dropout", 0.05, 0.25),
        "fusion_dropout": trial.suggest_float("fusion_dropout", 0.05, 0.20),
        "fusion_heads":   trial.suggest_categorical("fusion_heads", [4, 8]),
        "gcn_layers":     trial.suggest_int("gcn_layers", 6, 10),
        "gcn_alpha":      trial.suggest_float("gcn_alpha", 0.15, 0.50),
        "gcn_dropout":    trial.suggest_float("gcn_dropout", 0.10, 0.30),
        "tcn_dropout":    trial.suggest_float("tcn_dropout", 0.05, 0.20),
        "clf_dropout":    trial.suggest_float("clf_dropout", 0.25, 0.45),
